...
public class PIDEditor implements IPIDEditor {
  ...
  @Override
  public Optional<Map<String, Object>> getProperties(String pid)
    throws IOException {
    Dictionary<String, Object> properties =
      this.configurationAdmin.getConfiguration(pid).getProperties();
    return Optional.of(
      Collections
  ...
  @Override
  public Optional<Object> getProperty(String pid, String key)
    throws IOException {
  ...
  @Override
  public void createPIDFile(String pid, Map<String, Object> properties)
    throws IOException {
    Configuration configuration =
      this.configurationAdmin.createFactoryConfiguration(pid);
  ...
  @Override
  public void updateProperties(String pid, Map<String, Object> properties)
    throws IOException {
    for (Map.Entry<String, Object> entry : properties.entrySet()) {
      this.updateProperty(pid, entry.getKey(), entry.getValue());
    }
  }

  @Override
  public void updateProperty(String pid, String key, Object property)
    throws IOException {
  ...
  private Hashtable<String, Object> convertToHashtable(
